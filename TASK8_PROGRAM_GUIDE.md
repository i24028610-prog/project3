...
README_TASK8_UBUNTU.md
    Ubuntu 双系统真机运行说明：安装依赖、创建虚拟环境、训练和验证命令。
...
如果在 Ubuntu 双系统真机里运行，请优先看：

```text
C:\Users\25361\PycharmProjects\pythonProject3\README_TASK8_UBUNTU.md
```

Ubuntu 下不需要修改代码中的 Windows 路径；当前主线程序已经改成从项目目录自动寻找数据和 `.pt` 模型。
